  ...
  const reviews = [
    {
      ...
      review: t("Saved over $200 on my flight to London! The price comparison feature is incredibly fast and found a deal I couldn't see anywhere else."),
      rating: 5,
      date: "2 days ago"
    },
    {
    ...
    },
    {
      ...
      review: t("I travel for business constantly. The interface is clean, no annoying popups, and I always get the cheapest rates. Highly recommended."),
      rating: 5,
      date: "2 weeks ago"
    }
  ];
  ...
  return (
    <div className="w-full px-4 md:px-10 py-20 bg-gray-50 border-t border-gray-100 mt-10">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-black text-gray-900 mb-4">{t("What our travelers say")}</h2>
        <p className="text-gray-500 max-w-xl mx-auto">{t("Real experiences from people who booked their dream trips using HotelChap.")}</p>
      </div>
