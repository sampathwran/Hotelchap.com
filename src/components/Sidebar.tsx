    ...
    <>
      ...
      {pathname === '/' ? (
        <button 
          ...
          className="fixed top-3 right-3 md:top-8 md:left-8 z-[80] p-2 text-gray-800 md:bg-white/80 md:backdrop-blur-md md:shadow-sm hover:text-[#673AB7] md:hover:bg-white md:rounded-full transition-colors md:drop-shadow-md bg-transparent"
        >
          <Menu size={28} />
        </button>
      ) : (
