...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white shadow-[0_-5px_15px_rgba(0,0,0,0.1)] z-50 flex justify-around items-center h-[70px] px-2 overflow-x-auto pb-safe">
        {/* Combine first few items for mobile view */}
        {[...bookingServices.slice(0,3), userSection[0], userSection[1]].map((item, index) => (
          <Link 
            href={item.link} 
            key={index}
