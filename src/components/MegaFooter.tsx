        ...
        <div className="bg-gray-800 rounded-3xl p-8 mb-16 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex w-full md:w-auto gap-2">
            <input 
              ...
              className="w-full md:w-80 px-4 py-3 rounded-xl bg-gray-900 border border-gray-700 text-white focus:outline-none focus:border-[#673AB7]"
            />
            <button className="bg-[#673AB7] hover:bg-[#522b94] text-white px-6 py-3 rounded-xl font-bold transition">
              Subscribe
            </button>
          </div>
        </div>
