          ...
          <div className="space-y-12 text-gray-700 leading-relaxed text-[15px]">
            ...
            <section>
              ...
              <div className="pl-11 space-y-4">
                ...
                <p>
                  <strong>2.2.</strong> In addition, for some hotels, users have the possibility of booking the selected hotel through a direct connection to the hotel booking sites (third parties) ('HotelChap Express Booking'). As a result, the booking will be made directly on the hotel booking site and not on the HotelChap sites. In such cases, HotelChap is not the travel operator or the contractual party for the user, but only an agent providing the technical connection to the hotel booking site of a third party. By making a booking on the website of the third party, users agree to be bound by the terms and conditions of that booking site. Once a booking is made on the website of a third party, a contract is concluded between the booking site and the user, and therefore no contract is concluded between the user and HotelChap. HotelChap is no contractual party to the hotel booking and all and any claims of the user under the hotel reservation are to be asserted against the third party (the booking site) and not against HotelChap.
                </p>
                <p>
