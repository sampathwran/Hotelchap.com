    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <div className="relative w-full min-h-[500px] flex items-center justify-center py-12 md:py-0">
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1599640842225-85d111c60e6b?q=80&w=2074&auto=format&fit=crop')" }}
        ></div>
        <div className="absolute inset-0 bg-black/50"></div>
        
        <div className="relative z-10 w-full max-w-6xl px-4 md:px-8 flex flex-col items-center text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 drop-shadow-lg">Sail Away on an Ocean Adventure</h1>
          <p className="text-lg md:text-xl text-white/90 font-medium mb-8 drop-shadow-md">Compare deals from top cruise lines worldwide</p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-32 w-full text-center">
         ...
         <h2 className="text-4xl font-black text-gray-900 mb-6">More Luxury Cruises Features Coming Soon</h2>
